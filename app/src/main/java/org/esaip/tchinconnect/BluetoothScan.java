...
public class BluetoothScan extends Activity {
    ...
    public static void startScan(boolean autoEnable, BluetoothScanCallBack callBack, Activity activity) {
        ...
        if (mBluetoothAdapter != null) {
            ...
            Log.i("BluetoothScan","Bluetooth Scan is going to start");
    ...
    private static BluetoothAdapter.LeScanCallback mLeScanCallback = new BluetoothAdapter.LeScanCallback() {
        ...
        public void onLeScan(final BluetoothDevice device, int rssi, byte[] scanRecord) {
            Log.i("BluetoothScan", "Reach OnLeScan");
